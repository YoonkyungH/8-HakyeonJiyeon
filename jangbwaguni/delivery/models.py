...
#     # 수정요망
    ...
    #     (3, '3'),
    # )   
    # speed = models.CharField(max_length=1, choices=SCORE, verbose_name='스피드', null=True)
    # fresh = models.CharField(max_length=1, choices=SCORE, verbose_name='신선도', null=True)
    # accuracy = models.CharField(max_length=1, choices=SCORE, verbose_name='정확도', null=True)
