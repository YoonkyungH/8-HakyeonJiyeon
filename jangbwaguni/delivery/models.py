...
class rider(models.Model): # 배달원
    ...
    #     ('3', '3'),
    # )
    # speed = models.CharField(max_length=2, choices=SCORE, verbose_name='스피드')
    # fresh = models.CharField(max_length=2, choices=SCORE, verbose_name='신선도')
    # accuracy = models.CharField(max_length=2, choices=SCORE, verbose_name='정확도')
